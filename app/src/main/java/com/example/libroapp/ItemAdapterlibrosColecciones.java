...
public class ItemAdapterlibrosColecciones extends BaseAdapter {
    LayoutInflater mInflater;
    String [] Libros;
    String[] Descripcion;
    String []Autor;
    public ItemAdapterlibrosColecciones(){

    }

    public ItemAdapterlibrosColecciones(Context c, String[] L, String[] D,String[] A)
    {
        Libros=L;
        Descripcion=D;
        Autor=A;
