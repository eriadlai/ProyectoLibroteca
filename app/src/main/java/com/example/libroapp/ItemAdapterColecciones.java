...
public class ItemAdapterColecciones extends BaseAdapter {
    LayoutInflater mInflater;
    String [] Libros;
    String[] Descripcion;
    String []Autor;
    public ItemAdapterColecciones(){

    }

    public ItemAdapterColecciones(Context c, String[] L, String[] D,String[] A)
    {
        Libros=L;
        Descripcion=D;
        Autor=A;
